...
NetworkController::NetworkController(W5500Driver &w5500, const char *hostname)
    : w5500(w5500), hostname(hostname), wifiManager(), wifiConnected(false), ethernetConnected(false), configPortalActive(false), lastConnectionState(false), lastEthernetState(false), lastReconnectAttempt(0), configPortalStartTime(0), wifiSSID(nullptr), wifiPassword(nullptr)
{
